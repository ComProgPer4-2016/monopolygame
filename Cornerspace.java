...
public class Cornerspace extends Space
{
    ...
    ImageIcon i;
    public Cornerspace(ImageIcon n)
    {
        i=n;
    ...
    {
        int x = 1000-94;//initializing int x and assigning it to the int that is the result of the int
        ...
        int y = 0;//initializing int x and assigning it to the int that is the result of the int
        //returned by accessor method getWidth invoked on this instance of the class subtracted from the int that resulted from the
        //accesor method getWidth invoked on the img with
